...
captions = ["An adult, possibly male, gorilla is prominently featured in the image. This gorilla is standing upright, with its full body visible, and appears to be holding a baby gorilla in its arms. The two gorillas are standing in a lush green field, surrounded by trees.",
            ...
            "The right side of the image features a large, tall gorilla, possibly the mother, who is holding a baby gorilla. She is standing in the grass, and her face is clearly visible.", "A young, wild, and untamed baby chimpanzee is sitting in the grass. The chimp is holding onto a branch with both hands, and it's staring directly at the camera. The chimp's fur is a mixture of black and light brown, and it's sitting on the ground, with a grassy field as its backdrop.",
