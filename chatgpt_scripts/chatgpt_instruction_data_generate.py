...
class InstructionGenerater(object):
    ...
    def _generate_pos_data(self, caption1, caption2, motion_caption):
        ...
        motion_reason = " In addition, in the first frame, we observed that" + motion_caption + " And, in the second frame, the object\'s position aligns with this motion tendency. " + motion_caption
